...
export function Features() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-0 w-[600px] h-[600px] bg-gradient-to-r from-brand-500/8 to-transparent blur-3xl -z-10 noise-gradient" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-gradient-to-tl from-brand-500/8 to-transparent blur-3xl -z-10 noise-gradient" />
        ...
        >
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <Card
                  className="group p-6 glass-card rounded-xl h-full"
                ...
                >
                  ...
                  {/* Title */}
                  <h3 className="mb-2 text-lg font-display font-semibold group-hover:text-brand-300 transition-colors">
                    {feature.title}
                  </h3>
