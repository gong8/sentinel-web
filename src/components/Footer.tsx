...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/20 py-16 relative overflow-hidden">
      {/* Subtle gradient */}
      <div className="absolute inset-0 bg-gradient-to-t from-brand-500/[0.02] to-transparent" />
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 pt-8 border-t border-border/20 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <span>&copy; {currentYear} SENTINEL. All rights reserved.</span>
          ...
          <div className="flex items-center gap-6">
            <span className="font-mono text-xs text-muted-foreground/60 bg-muted/20 px-2 py-1 rounded">
              v0.1.0
            </span>
          </div>
        </div>
